...
# with command line options: miniAOD_data -s RAW2DIGI,L1Reco,RECO,EI,PAT --runUnscheduled --nThreads 4 --data --era Run2_2018,pf_badHcalMitigation --scenario pp --conditions 102X_dataRun2_v12 --eventcontent AOD,MINIAOD --datatier AOD,MINIAOD --filein file:root://cmseos.fnal.gov//store/user/huiwang/HCAL/DoubleMuon_Run2018A-v1_RAW_6601F23E-0E65-E811-859E-FA163E98BEC0.root -n 100 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('miniAOD_data nevts:100'),
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('data_AOD_RAW2DIGI_L1Reco_RECO_EI_PAT.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('data_miniAOD_RAW2DIGI_L1Reco_RECO_EI_PAT.root'),
