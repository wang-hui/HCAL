...
hbheprereco = cms.EDProducer(
    ...
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_respCorr.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_zeroOut_respCorr.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_zeroOut_PU_respCorr.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_zeroOut_PU_respCorr_my_ieta26.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_JP_respCorr.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_JP_respCorr_E50.root"),
    DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_JP_respCorr_E50_fix_HB.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_JP_respCorr_E50_DLPHIN_energy.root"),
    #DLPHIN_pb_SF = cms.string(DLPHIN_pb_folder + "DLPHIN_respCorr_simHit_energy_ieta27.root"),
    ...
    #DLPHIN_pb_2dHE = cms.string(DLPHIN_pb_folder + "model_ConvLSTM.pb"),
    DLPHIN_run = cms.bool(False),
    DLPHIN_scale = cms.bool(True),
    DLPHIN_save = cms.bool(False),
    DLPHIN_truncate = cms.bool(False),
    DLPHIN_print_1d = cms.bool(False),
    DLPHIN_print_2d_HB = cms.bool(False),
    DLPHIN_print_2d_HE = cms.bool(False),
    simHits_run = cms.bool(True),
    simHits_save = cms.bool(True),
    max_simHit_time = cms.double(125.0),
