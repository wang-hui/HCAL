...
folder_name = "UL_DYJetsToEE_M-50_RECO_PU_DLPHIN_respCorr_PNieta"        #folder name for the result files in EOS
...
file_list = "../FileList/UL_DYJetsToEE_M-50_RAW_PU.list"
tot_jobs = 2000
