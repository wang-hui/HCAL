...
folder_name = "UL_Single_Pion_gun_E_2to200_RECO_simHit_energy_JP_respCorr_E50"        #folder name for the result files in EOS
...
file_list = "../FileList/UL_Single_Pion_gun_E_2to200_RAW_noPU.list"
tot_jobs = 1000
