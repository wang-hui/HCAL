...
# with command line options: reco_data --filein file:step2.root --data --eventcontent RECO --conditions 124X_dataRun3_Prompt_v4 --step RAW2DIGI,RECO --nThreads 4 --geometry DB:Extended --era Run3 -n 10 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        "/store/data/Run2022C/JetHT/RAW/v1/000/356/077/00000/1c68d081-1e82-483d-a255-c62ae967a99f.root"
    ),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('reco_data nevts:10'),
...
DLPHIN.DLPHINConfig.DLPHIN_apply_respCorr = cms.bool(False) 
