...
reco_vs_gen_depthG1_PUS30_h = rt.TH2F("reco_vs_gen_depthG1_PUS30_h", "reco vs gen, depth > 1, PU < 30", 100, 0.0, 100.0, 100, 0.0, 100.0)
...
ratio_depthG1_PUS30_h = rt.TH1F("ratio_depthG1_PUS30_h", "reco/gen for gen > 1 GeV, depth > 1, PU < 30", 100, 0.0, 2.0)
...
for i in range(Nrows):
	...
	if depth == 1:
		...
		if PU < 30: reco_vs_gen_depthG1_PUS30_h.Fill(reco_energy, gen_energy)
	...
	if gen_energy > 1:
		...
		if depth == 1:
			...
			if PU < 30: ratio_depthG1_PUS30_h.Fill(ratio)
